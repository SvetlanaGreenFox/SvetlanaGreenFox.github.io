...
import MyPhoto from './assets/profile-alt.jpg';
      ...
      <div className={styles.container}>
        <div className={styles['home__content']}>
          <div className={className(styles['content__item'], styles['left-item'])}>
            <img
              className={className(styles.design, styles['design__points'])}
              src={points}
              alt="design"
            />
            <img
              className={className(styles.design, styles['design__ellipse-2'])}
              src={ellipse_2}
              alt="design"
            />
            <div className={styles['photo-wrapper']}>
              <img className={styles['profile']} src={MyPhoto} alt="My profile" />
            </div>
            <img
              className={className(styles.design, styles['design__ellipse-3'])}
              src={ellipse_3}
              alt="design"
            />
            <img
              className={className(styles.design, styles['design__ellipse-1'])}
              src={ellipse_1}
              alt="design"
            />
          </div>
          <div className={className(styles['content__item'], styles['right-item'])}>
            <div className={styles['home__description']}>
              <img
                className={className(styles.design, styles['design__ellipse-7'])}
                src={ellipse_7}
                alt="design"
              />
              <img
                className={className(styles.design, styles['design__ellipse-5'])}
                src={ellipse_5}
                alt="design"
              />
              <h1 className={className(styles['home__title'], styles['title-1'])}>Привет!</h1>
              <h2 className={className(styles['home__title'], styles['title-2'])}>
                Меня зовут Света.
              </h2>
              <p className={styles['home__subtitle']}>Junior Frontend developer</p>
              <img
                className={className(styles.design, styles['design__ellipse-4'])}
                src={ellipse_4}
                alt="design"
              />
            </div>
            <div className={styles['home__btn-wrap']}>
              ...
              <img
                className={className(styles.design, styles['design__point'])}
                src={point}
                alt="design"
              />
            </div>
          ...
          <img
            className={className(styles.design, styles['design__ellipse-6'])}
            src={ellipse_6}
            alt="design"
          />
        </div>
